#decompiled by PDM31
import os, sys
print '\x1b[1;32mMasukan ID: Abil dan Password: Arrasyid untuk Login'
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6285268030938&text=Assalamualaikum')
...
if sandi == 'Arrasyid' and user == 'Abil':
